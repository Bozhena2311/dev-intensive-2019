...
class MainActivity : AppCompatActivity(), View.OnClickListener {
     ...
     *
     * Этот метод также предоставляется Bundle, содержащий ранее сохраненное
     ...
     *
     * запуск воспроизводения анимации, аудио и видео
     ...
     * приостановка потоков, отслеживани] показаний датчиков, запросов к GPS, таймеров, сервисов или других процессов,
     * которые нужны исключительно для обновления пользовательского интерфейса
     *
